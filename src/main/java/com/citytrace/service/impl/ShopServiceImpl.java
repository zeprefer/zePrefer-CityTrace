...
import com.citytrace.mapper.ShopMapper;
import com.citytrace.service.IShopService;
import com.citytrace.utils.CacheClient;
...
import static com.citytrace.utils.RedisConstants.*;
...
public class ShopServiceImpl extends ServiceImpl<ShopMapper, Shop> implements IShopService {
    ...
    public Result queryShopByType(Integer typeId, Integer current, Double x, Double y, String sortBy) {
        // 人气和评分使用数据库排序；仅允许固定字段，避免把请求参数直接拼接进 SQL。
    ...
    private void warmShopGeoCache(Integer typeId, String key) {
